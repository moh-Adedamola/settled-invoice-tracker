  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between gap-4 border-b border-line-subtle px-4 py-3">
        ...
        <p className="text-small text-ink-muted">{entries.length} events</p>
      </div>
        ...
        <ul className="flex flex-col">
          {entries.map((entry) => (
            <li
              ...
              className="flex items-start gap-3 border-t border-line-subtle px-4 py-2.5 first:border-t-0"
            >
              <span
                aria-hidden="true"
